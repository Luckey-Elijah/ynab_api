...
part of 'spec_v1_swagger.models.swagger.dart';
...
Account _$AccountFromJson(Map<String, dynamic> json) => Account(
      ...
      clearedBalance: json['cleared_balance'] as num,
      unclearedBalance: json['uncleared_balance'] as num,
...
Category _$CategoryFromJson(Map<String, dynamic> json) => Category(
      ...
      note: json['note'] as String?,
      budgeted: json['budgeted'] as num,
      activity: json['activity'] as num,
      balance: json['balance'] as num,
      ...
      goalTarget: json['goal_target'] as num?,
      ...
      goalUnderFunded: json['goal_under_funded'] as num?,
      goalOverallFunded: json['goal_overall_funded'] as num?,
      goalOverallLeft: json['goal_overall_left'] as num?,
      deleted: json['deleted'] as bool,
    );
...
MonthSummary _$MonthSummaryFromJson(Map<String, dynamic> json) => MonthSummary(
      ...
      budgeted: json['budgeted'] as num,
      activity: json['activity'] as num,
      toBeBudgeted: json['to_be_budgeted'] as num,
...
BudgetDetailResponse$Data _$BudgetDetailResponse$DataFromJson(
    ...
    BudgetDetailResponse$Data(
      ...
      serverKnowledge: json['server_knowledge'] as num,
    );
